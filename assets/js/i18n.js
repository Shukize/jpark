...
const I18N = {
  ...
  "th": {
    ...
    "rooms.lede": "ห้องพักและห้องสวีทแปดสไตล์ ตั้งแต่ห้องเดี่ยวกะทัดรัดไปจนถึงห้องสวีทสองห้องนอน แต่ละห้องมาพร้อมเครื่องนอนนุ่มสบาย โทนร่วมสมัยที่ผ่อนคลาย และวิวเมืองอันเงียบสงบ",
    ...
    "rooms.grandSuiteName": "แกรนด์ สวีท 1 ห้องนอน",
  ...
  "en": {
    ...
    "rooms.lede": "Eight room and suite styles — from a smart single to a two-bedroom residence — each with plush bedding, contemporary calm and quiet city views.",
    ...
    "rooms.grandSuiteName": "Grand Suite 1 Bedroom",
  ...
  "ja": {
    ...
    "rooms.eyebrow": "ご滞在",
    "rooms.title": "客室・スイート",
    "rooms.lede": "8つの客室・スイートタイプ。コンパクトなシングルから2ベッドルームのレジデンスまで、いずれも上質な寝具、落ち着いた現代的な設え、静かな街の眺めを備えています。",
    "rooms.singleSize": "24 m²",
    ...
    "rooms.grandSuiteSize": "75 m²",
    "rooms.grandSuiteName": "グランドスイート 1ベッドルーム",
  ...
  "zh-Hans": {
    ...
    "rooms.eyebrow": "入住体验",
    "rooms.title": "客房与套房",
    "rooms.lede": "八种客房与套房风格——从精巧的单人房到两卧居所——皆配柔软寝具、沉静的当代格调与静谧的城市景观。",
    "rooms.singleSize": "24 m²",
  ...
  "zh-Hant": {
    ...
    "rooms.eyebrow": "入住體驗",
    "rooms.title": "客房與套房",
    "rooms.lede": "八種客房與套房風格——從精巧的單人房到兩臥居所——皆配柔軟寢具、沉靜的當代格調與靜謐的城市景觀。",
    "rooms.singleSize": "24 m²",
