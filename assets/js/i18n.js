...
const I18N = {
  ...
  "th": {
    ...
    "rooms.grandPremiereDesc": "ห้องพรีเมียมที่กว้างขวางที่สุดของเรา เตียงเดี่ยว พร้อมสิ่งอำนวยความสะดวกที่เหนือกว่าและมุมนั่งเล่นกว้างพร้อมวิวเมืองอันเงียบสงบ",
  ...
  "en": {
    ...
    "rooms.grandPremiereDesc": "Our most generous Premium — a single bed, upgraded amenities and a wide lounge area framed by quiet city views.",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteDesc": "A one-bedroom suite with a full living and dining area, a separate bedroom and premium finishes — made for relaxed, longer stays.",
    "rooms.execSuiteSize": "75 m²",
    "rooms.execSuiteName": "Executive Suite",
    "rooms.execSuiteDesc": "A refined one- or two-bedroom residence with expansive living and dining spaces, a kitchen and elegant finishes throughout. The two-bedroom configuration shares a single bathroom between both bedrooms. A microwave and extra kitchenware can be arranged on request, subject to availability.",
  ...
  "ja": {
    ...
    "rooms.grandPremiereSize": "49 m²",
    "rooms.grandPremiereDesc": "最も広々としたプレミアム。シングルベッド、充実したアメニティと、静かな街の眺めに包まれた広いラウンジエリアを備えています。",
    "rooms.premiereSuiteSize": "73 m²",
