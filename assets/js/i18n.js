...
const I18N = {
  ...
  "th": {
    ...
    "rooms.grandPremiereName": "แกรนด์ พรีเมียร์",
    "rooms.grandPremiereDesc": "ห้องพรีเมียร์ที่กว้างขวางที่สุดของเรา เลือกเตียงเดี่ยวหรือเตียงคู่แฝด พร้อมสิ่งอำนวยความสะดวกที่เหนือกว่าและมุมนั่งเล่นกว้างพร้อมวิวเมืองอันเงียบสงบ",
    "rooms.premiereSuiteSize": "73 ตร.ม.",
    "rooms.premiereSuiteName": "พรีเมียร์ สวีท",
  ...
  "en": {
    ...
    "rooms.grandPremiereName": "Grand Premiere",
    "rooms.grandPremiereDesc": "Our most generous Premiere — single or twin bedding, upgraded amenities and a wide lounge area framed by quiet city views.",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteName": "Premiere Suite",
  ...
  "ja": {
    ...
    "rooms.premiereSize": "49 m²",
    "rooms.premiereName": "プレミア",
    "rooms.premiereDesc": "ワンランク上の客室。シングルまたはツイン、上質なリネン、広々としたワークエリアと落ち着いた洗練の雰囲気を備えています。",
    "rooms.grandPremiereSize": "49 m²",
    "rooms.grandPremiereName": "グランドプレミア",
    "rooms.grandPremiereDesc": "最も広々としたプレミア。シングルまたはツイン、充実したアメニティと、静かな街の眺めに包まれた広いラウンジエリアを備えています。",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteName": "プレミアスイート",
  ...
  "zh-Hans": {
    ...
    "rooms.premiereSize": "49 m²",
    "rooms.premiereName": "至尊房",
    "rooms.premiereDesc": "升级客房，可选单人床或双床，配高级床品、宽敞办公区，全室格调沉静而精致。",
    "rooms.grandPremiereSize": "49 m²",
    "rooms.grandPremiereName": "豪华至尊房",
    "rooms.grandPremiereDesc": "我们最为宽敞的至尊房，可选单人床或双床，配升级设施与宽阔休憩区，静享城市景观。",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteName": "至尊套房",
  ...
  "zh-Hant": {
    ...
    "rooms.grandPremiereSize": "49 m²",
    "rooms.grandPremiereName": "豪華至尊房",
    "rooms.grandPremiereDesc": "我們最為寬敞的至尊房，可選單人床或雙床，配升級設施與寬闊休憩區，靜享城市景觀。",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteName": "至尊套房",
