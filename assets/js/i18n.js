...
const I18N = {
  ...
  "th": {
    ...
    "rooms.grandPremiereDesc": "ห้องพรีเมียร์ที่กว้างขวางที่สุดของเรา เตียงเดี่ยว พร้อมสิ่งอำนวยความสะดวกที่เหนือกว่าและมุมนั่งเล่นกว้างพร้อมวิวสระว่ายน้ำ",
    "rooms.premiereSuiteSize": "73 ตร.ม.",
    "rooms.premiereSuiteDesc": "ห้องสวีทหนึ่งห้องนอน พร้อมพื้นที่นั่งเล่นและรับประทานอาหารครบครัน ห้องนอนแยกส่วน และวัสดุระดับพรีเมียม เหมาะสำหรับการพักผ่อนที่ยาวนาน",
    "rooms.execSuiteSize": "75 ตร.ม.",
    "rooms.execSuiteName": "เอ็กเซกคิวทีฟ สวีท",
    "rooms.execSuiteDesc": "ห้องสวีทหนึ่งหรือสองห้องนอนสุดหรู พร้อมพื้นที่นั่งเล่นและรับประทานอาหารกว้างขวาง ครัว และวัสดุตกแต่งอันสง่างามตลอดทั้งห้อง การจัดแบบสองห้องนอนจะใช้ห้องน้ำร่วมกันหนึ่งห้อง สามารถขอไมโครเวฟและอุปกรณ์ครัวเพิ่มเติมได้ ทั้งนี้ขึ้นอยู่กับความพร้อมของโรงแรม",
    ...
    "rooms.prestigeSingleDesc": "ห้องพักหรู เตียงเดี่ยว พร้อมเครื่องนอนพรีเมียม พื้นที่ทำงานกว้างขวาง และสิ่งอำนวยความสะดวกที่เหนือกว่า เพื่อการพักที่สบายและผ่อนคลาย",
    "rooms.prestigeTwinDesc": "ห้องพักหรู เตียงคู่แฝด พร้อมเครื่องนอนพรีเมียม พื้นที่ทำงานกว้างขวาง และสิ่งอำนวยความสะดวกที่เหนือกว่า เพื่อการพักที่สบายและผ่อนคลาย",
  ...
  "ja": {
    ...
    "rooms.grandPremiereSize": "49 m²",
    "rooms.grandPremiereDesc": "最も広々としたプレミア。シングルベッド、充実したアメニティと、プールの眺めに包まれた広いラウンジエリアを備えています。",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteDesc": "1ベッドルームのスイート。充実したリビング・ダイニング、独立したベッドルーム、上質な設えを備え、ゆったりとした長めのご滞在に。",
    "rooms.execSuiteSize": "75 m²",
    "rooms.execSuiteName": "エグゼクティブスイート",
    "rooms.execSuiteDesc": "1または2ベッドルームの洗練されたレジデンス。広々としたリビング・ダイニング、キッチン、優雅な設えを全室に。2ベッドルームタイプはバスルームを2部屋で共有します。電子レンジや調理器具の追加はリクエスト可能です（ホテルの在庫状況によります）。",
    "rooms.grandSuiteSize": "75 m²",
    ...
    "rooms.prestigeSize": "45 m²",
    "rooms.prestigeSingleDesc": "洗練された客室。シングルベッド、上質な寝具、広めのワークエリア、充実したアメニティを備え、快適でやすらかなご滞在を。",
    "rooms.prestigeTwinDesc": "洗練された客室。ツインベッド、上質な寝具、広めのワークエリア、充実したアメニティを備え、快適でやすらかなご滞在を。",
    "rooms.cornerSize": "55 m²",
  ...
  "zh-Hans": {
    ...
    "rooms.grandPremiereSize": "49 m²",
    "rooms.grandPremiereDesc": "我们最为宽敞的高级房，单人床，配升级设施与宽阔休憩区，静享城市景观。",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteDesc": "一卧套房，配完整起居与用餐区、独立卧室及高级装饰，专为从容长住而设。",
    "rooms.execSuiteSize": "75 m²",
    "rooms.execSuiteName": "行政套房",
    "rooms.execSuiteDesc": "精致的一卧或两卧居所，配宽敞起居与用餐空间、厨房及全室雅致装饰。两卧配置的两间卧室共用一个卫浴。可另行申请微波炉及厨具，视酒店库存而定。",
    "rooms.grandSuiteSize": "75 m²",
    ...
    "rooms.prestigeSize": "45 m²",
    "rooms.prestigeSingleDesc": "雅致客房，单人床，配高级寝具、宽敞办公区与升级设施，入住舒适安稳。",
    "rooms.prestigeTwinDesc": "雅致客房，双床，配高级寝具、宽敞办公区与升级设施，入住舒适安稳。",
    "rooms.cornerSize": "55 m²",
  ...
  "zh-Hant": {
    ...
    "rooms.grandPremiereSize": "49 m²",
    "rooms.grandPremiereDesc": "我們最為寬敞的高級房，單人床，配升級設施與寬闊休憩區，靜享城市景觀。",
    "rooms.premiereSuiteSize": "73 m²",
    "rooms.premiereSuiteDesc": "一臥套房，配完整起居與用餐區、獨立臥室及高級裝飾，專為從容長住而設。",
    "rooms.execSuiteSize": "75 m²",
    "rooms.execSuiteName": "行政套房",
    "rooms.execSuiteDesc": "精緻的一臥或兩臥居所，配寬敞起居與用餐空間、廚房及全室雅致裝飾。兩臥配置的兩間臥室共用一個衛浴。可另行申請微波爐及廚具，視飯店庫存而定。",
    "rooms.grandSuiteSize": "75 m²",
    ...
    "rooms.prestigeSize": "45 m²",
    "rooms.prestigeSingleDesc": "雅致客房，單人床，配高級寢具、寬敞辦公區與升級設施，入住舒適安穩。",
    "rooms.prestigeTwinDesc": "雅致客房，雙床，配高級寢具、寬敞辦公區與升級設施，入住舒適安穩。",
    "rooms.cornerSize": "55 m²",
