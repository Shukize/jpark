...
(function () {
  ...
  I.registerI18n({
    en: {
      ...
      'pol.book.changeP': 'To change or cancel a reservation, contact the hotel by phone or email with your confirmation number, and the front desk will take care of it. There is no charge to cancel a standard booking up to 24 hours before your check-in date.',
      'pol.book.changeP2': 'Cancelling less than 24 hours before check-in, or not arriving without telling us (a no-show), may be charged at one night’s room rate.',
      'pol.book.refundH': 'Refunds',
      'pol.book.refundP': 'If you paid online and your booking is cancelled within the free-cancellation window, the amount is refunded to the card or account you paid from. We start the refund within 7 business days of the cancellation; your bank may then take several more days to show it.',
      'pol.book.refundP2': 'Refunds are always returned to the original payment method. We cannot refund to a different card, to cash, or to a different person’s account.',
      'pol.book.nonrefH': 'Non-refundable bookings',
      'pol.book.nonrefP': 'During certain busy or holiday periods we require full prepayment, and those bookings are non-refundable if you cancel or do not arrive. When this applies it is stated clearly on the booking form before you pay, and again on your confirmation email. It never applies without that notice. The key-card deposit above remains refundable in every case.',
    ...
    th: {
      ...
      'pol.book.changeP': 'หากต้องการเปลี่ยนแปลงหรือยกเลิกการจอง กรุณาติดต่อโรงแรมทางโทรศัพท์หรืออีเมลพร้อมแจ้งหมายเลขการจอง แล้วแผนกต้อนรับจะดำเนินการให้ การยกเลิกการจองแบบปกติล่วงหน้าไม่น้อยกว่า 24 ชั่วโมงก่อนวันเช็คอิน ไม่มีค่าใช้จ่าย',
      'pol.book.changeP2': 'การยกเลิกภายใน 24 ชั่วโมงก่อนเช็คอิน หรือการไม่เข้าพักโดยไม่แจ้งล่วงหน้า (No-show) อาจมีการเรียกเก็บค่าห้องพัก 1 คืน',
      'pol.book.refundH': 'การคืนเงิน',
      'pol.book.refundP': 'หากท่านชำระเงินออนไลน์และยกเลิกการจองภายในระยะเวลาที่ยกเลิกได้โดยไม่มีค่าใช้จ่าย เราจะคืนเงินเข้าบัตรหรือบัญชีที่ท่านใช้ชำระ โดยเราจะเริ่มดำเนินการคืนเงินภายใน 7 วันทำการนับจากวันที่ยกเลิก ทั้งนี้ธนาคารของท่านอาจใช้เวลาเพิ่มเติมอีกหลายวันจึงจะแสดงรายการ',
      'pol.book.refundP2': 'การคืนเงินจะทำกลับไปยังช่องทางการชำระเงินเดิมเสมอ เราไม่สามารถคืนเงินเข้าบัตรใบอื่น คืนเป็นเงินสด หรือคืนเข้าบัญชีของบุคคลอื่นได้',
      'pol.book.nonrefH': 'การจองแบบไม่คืนเงิน',
      'pol.book.nonrefP': 'ในช่วงที่มีผู้เข้าพักจำนวนมากหรือช่วงวันหยุดบางช่วง เราจำเป็นต้องเรียกเก็บเงินล่วงหน้าเต็มจำนวน และการจองดังกล่าวจะไม่คืนเงินหากท่านยกเลิกหรือไม่เข้าพัก กรณีนี้จะระบุไว้อย่างชัดเจนในแบบฟอร์มการจองก่อนที่ท่านจะชำระเงิน และระบุอีกครั้งในอีเมลยืนยันการจอง จะไม่มีการใช้เงื่อนไขนี้โดยไม่แจ้งให้ทราบ ทั้งนี้เงินมัดจำบัตรคีย์การ์ดข้างต้นยังคงคืนให้ทุกกรณี',
    ...
    ja: {
      ...
      'pol.book.changeP': 'ご予約の変更・キャンセルをご希望の場合は、予約番号をお控えのうえ、お電話またはメールにてホテルへご連絡ください。フロントにて対応いたします。通常のご予約は、チェックイン日の24時間前までは無料でキャンセルいただけます。',
      'pol.book.changeP2': 'チェックインの24時間前を過ぎてからのキャンセル、またはご連絡のないご不泊（ノーショー）の場合は、1泊分の室料を申し受けることがあります。',
      'pol.book.refundH': '返金について',
      'pol.book.refundP': 'オンラインでお支払いいただき、無料キャンセル期間内にキャンセルされた場合は、お支払いに使用されたカードまたは口座へ返金いたします。キャンセルから7営業日以内に返金手続きを開始しますが、ご利用の金融機関での反映にはさらに数日を要する場合があります。',
      'pol.book.refundP2': '返金は常に元のお支払い方法へ行います。別のカード、現金、または他のお客様の口座への返金はいたしかねます。',
      'pol.book.nonrefH': '返金不可のご予約',
      'pol.book.nonrefP': '繁忙期や特定の休日期間には全額前払いをお願いしており、そのご予約はキャンセルまたはご不泊の場合に返金いたしかねます。該当する場合は、お支払い前の予約フォームおよび確定メールにて明示いたします。事前の明示なくこの条件が適用されることはありません。上記のキーカードデポジットはいかなる場合も返金対象です。',
    ...
    'zh-Hans': {
      ...
      'pol.book.changeP': '如需变更或取消预订，请携预订编号致电或发送邮件与酒店联系，前台将为您处理。常规预订在入住日期前 24 小时以上取消，不收取任何费用。',
      'pol.book.changeP2': '在入住前不足 24 小时取消，或未告知即未入住（No-show），可能按一晚房费收取费用。',
      'pol.book.refundH': '退款',
      'pol.book.refundP': '如您已在线支付，并在免费取消期限内取消预订，款项将退回至您付款所用的银行卡或账户。我们会在取消后 7 个工作日内发起退款；您的开户行可能还需数日方能显示到账。',
      'pol.book.refundP2': '退款始终退回原支付方式。我们无法退款至其他银行卡、以现金退还，或退至他人账户。',
      'pol.book.nonrefH': '不可退款的预订',
      'pol.book.nonrefP': '在部分旺季或节假日期间，我们需要全额预付，此类预订在取消或未入住时不予退款。适用时，我们会在您付款前的预订表单中明确说明，并在确认邮件中再次说明。未经上述提示，绝不会适用该条件。上述房卡押金在任何情况下仍可退还。',
    ...
    'zh-Hant': {
      ...
      'pol.book.changeP': '如需變更或取消訂房，請攜訂房編號致電或寄送電子郵件與酒店聯繫，櫃檯將為您處理。一般訂房在入住日期前 24 小時以上取消，不收取任何費用。',
      'pol.book.changeP2': '在入住前不足 24 小時取消，或未告知即未入住（No-show），可能按一晚房費收取費用。',
      'pol.book.refundH': '退款',
      'pol.book.refundP': '如您已線上付款，並在免費取消期限內取消訂房，款項將退回至您付款所用的信用卡或帳戶。我們會在取消後 7 個工作天內發起退款；您的發卡銀行可能還需數日方能顯示入帳。',
      'pol.book.refundP2': '退款一律退回原付款方式。我們無法退款至其他信用卡、以現金退還，或退至他人帳戶。',
      'pol.book.nonrefH': '不可退款的訂房',
      'pol.book.nonrefP': '在部分旺季或連假期間，我們需要全額預付，此類訂房在取消或未入住時恕不退款。適用時，我們會在您付款前的訂房表單中明確說明，並在確認郵件中再次說明。未經上述提示，絕不會適用該條件。上述房卡押金在任何情況下仍可退還。',
