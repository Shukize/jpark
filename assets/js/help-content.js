    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "Give a guest a receipt", d: "Click Receipt in the Payment record box. It opens on Internal copy, which also shows what the payment company deducted and what the hotel actually receives. BEFORE you print anything to hand to a guest, switch to Guest copy — that removes our fees and leaves just the stay, the amount, the card and the payment time. Then Print." },
          { t: "Print a booking", d: "Click Print booking on any booking — including the ones being paid at the desk, which have no receipt yet. It opens on Guest copy, in the guest’s own language and ready to hand over: the rooms, the dates, what is included, the total and what is still to pay. Front desk copy adds our own side of it — where the booking came from, the staff label, the payment record, and who cancelled it and why. Never hand that copy to a guest. Then Print." },
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "Live Chat", d: "The Live Chat tab controls what the website's chat assistant tells guests. Reword any answer, change the times or details inside it, choose which words trigger it, turn answers on or off, or add a brand-new answer — then click Save Live Chat. Type once in your language and it is translated into the other four, and it reaches every guest device right away." },
          ...
          { t: "How many rooms", d: "In the Sections tab, set how many rooms of each type can be booked for the same night. Each row also shows how many are still free tonight. Single and Twin share one number — they are the same rooms with a different bed set-up." },
          { t: "You never count by hand", d: "You only set the total. A booking takes a room off the nights it covers, and it comes back the moment the stay ends or the booking is cancelled. Set the count to 0 to stop selling a type without hiding it." },
      ...
      {
        id: "payments", ico: "\ud83d\udcb3", title: "Payments",
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "ออกใบเสร็จให้ผู้เข้าพัก", d: "กด “ใบเสร็จ” ในกล่องบันทึกการชำระเงิน ระบบจะเปิดที่ “สำเนาภายใน” ซึ่งแสดงค่าธรรมเนียมที่ถูกหักและยอดที่โรงแรมได้จริงด้วย ก่อนพิมพเอกสารที่จะมอบให้ผู้เข้าพัก ให้สลับไปที่ “สำเนาสำหรับผู้เข้าพัก” ก่อนเสมอ ซึ่งจะตัดค่าธรรมเนียมออก แล้วจึงกดพิมพ" },
          { t: "พิมพ์ใบจอง", d: "กด “พิมพ์ใบจอง” ได้กับทุกการจอง รวมถึงรายการที่ยังไม่ได้ชำระเงินและยังไม่มีใบเสร็จ ระบบจะเปิดที่ “สำเนาสำหรับผู้เข้าพัก” เป็นภาษาของผู้เข้าพักเอง พร้อมมอบให้ได้ทันที ทั้งห้องพัก วันที่ สิ่งที่รวมอยู่ ยอดรวม และยอดที่ต้องชำระ ส่วน “สำเนาสำหรับเคาน์เตอร์” จะเพิ่มข้อมูลภายใน เช่น ช่องทางการจอง บันทึกของพนักงาน บันทึกการชำระเงิน และถ้าถูกยกเลิก ก็จะบอกว่าใครยกเลิกและเพราะอะไร อย่ามอบสำเนานี้ให้ผู้เข้าพัก จากนั้นจึงกด “พิมพ์”" },
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "แชทสด", d: "แท็บแชทสดควบคุมสิ่งที่ผู้ช่วยแชทของเว็บไซต์บอกผู้เข้าพัก แก้ถ้อยคำคำตอบใด ๆ เปลี่ยนเวลาหรือรายละเอียดในคำตอบ เลือกคำที่ใช้กระตุ้น เปิด-ปิดคำตอบ หรือเพิ่มคำตอบใหม่ แล้วกด “บันทึกแชทสด” พิมพ์ครั้งเดียวในภาษาของคุณ ระบบจะแปลเป็นอีกสี่ภาษา และไปถึงอุปกรณ์ของผู้เข้าพักทุกเครื่องทันที" },
          ...
          { t: "จำนวนห้องพัก", d: "ในแท็บส่วนต่าง ๆ ของเว็บไซต์ กำหนดว่าห้องแต่ละประเภทจองได้กี่ห้องในคืนเดียวกัน แต่ละแถวจะแสดงด้วยว่าคืนนี้ยังว่างกี่ห้อง ห้องเตียงเดี่ยวและเตียงคู่ใช้จำนวนร่วมกัน เพราะเป็นห้องเดียวกันแต่จัดเตียงต่างกัน" },
          { t: "ไม่ต้องนับเอง", d: "คุณกำหนดแค่จำนวนทั้งหมด เมื่อมีการจอง ห้องจะถูกหักออกจากคืนที่เข้าพัก และกลับมาว่างทันทีที่เข้าพักครบกำหนดหรือมีการยกเลิก ถ้าต้องการหยุดขายห้องประเภทใดโดยไม่ซ่อนออกจากเว็บไซต์ ให้ตั้งจำนวนเป็น 0" },
      ...
      {
        id: "payments", ico: "\ud83d\udcb3", title: "\u0e01\u0e32\u0e23\u0e0a\u0e33\u0e23\u0e30\u0e40\u0e07\u0e34\u0e19",
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "領収書をお渡しする", d: "「お支払い記録」の中の「領収書」を押します。最初は「社内用」で開き、決済会社の手数料とホテルの受取額も表示されます。お客様にお渡しするものを印刷する前に、必ず「お客様用」に切り替えてください。手数料の欄が消え、ご滞在・金額・カード・お支払い日時だけになります。" },
          { t: "予約内容を印刷する", d: "どの予約でも「予約内容を印刷」を押せます。領収書のない、チェックイン時にお支払いの予約でも印刷できます。最初はお客様の言語の「お客様用」で開き、そのままお渡しできます（お部屋、日程、含まれるもの、合計、未払額）。「フロント用」には予約経路、スタッフメモ、お支払い記録、キャンセルされた場合は誰がなぜ取り消したかが加わります。こちらはお客様にはお渡ししないでください。最後に「印刷」を押します。" },
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "ライブチャット", d: "ライブチャットタブは、サイトのチャットアシスタントが宿泊客に伝える内容を管理します。任意の回答を書き換え、回答内の時間や詳細を変更し、呼び出すキーワードを選び、回答のオン・オフを切り替え、新しい回答を追加して「ライブチャットを保存」を押します。ご自分の言語で一度入力すれば残り4言語へ翻訳され、すべての宿泊客の端末にすぐ届きます。" },
          { t: "セクション", d: "チェックの入切でセクションの表示・非表示を切り替え、サイト上部にお知らせバナーを出し、満室の客室タイプ（客室の掲載可否）やデイユースの棟を一時的に非表示にできます。" },
          { t: "客室数", d: "セクションタブで、各タイプを同じ日に何室まで予約できるかを設定します。各行には今夜の空室数も表示されます。シングルとツインはベッドの配置が違うだけの同じ客室なので、室数は共通です。" },
          { t: "手作業での増減は不要", d: "設定するのは総室数だけです。予約が入るとその日程から1室減り、宿泊が終わるか予約がキャンセルされた時点で戻ります。サイトから隠さずに販売だけ止めたい場合は 0 にしてください。" },
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "给客人开收据", d: "在“支付记录”框中点“收据”。默认打开的是“内部存根”，还会显示支付公司扣了多少、酒店实收多少。打印交给客人的单据之前，请先切换到“客人联”—— 那会去掉手续费信息，只保留住宿、金额、卡片和付款时间。然后再点打印。" },
          { t: "打印预订单", d: "任何一笔预订都可以点“打印预订单”，包括还没有收据、入住时才付款的预订。默认打开的是“客人联”，用客人自己的语言显示，可以直接交给客人：房间、日期、含哪些服务、合计以及尚需支付的金额。“前台存根”会另外加上我们自己的信息 —— 预订渠道、员工备注、支付记录，以及由谁取消、原因是什么。这一联不要交给客人。然后点打印。" },
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "在线聊天", d: "“在线聊天”标签页控制网站聊天助手对客人所说的内容。改写任意回答，修改其中的时间或细节，选择触发它的词语，开启或关闭回答，或添加全新的回答 — 然后点击“保存在线聊天”。用你的语言输入一次，系统会翻译成另外四种语言，并立即送达每位客人的设备。" },
          { t: "板块", d: "打勾或取消打勾来显示 / 隐藏板块，在网站顶部发布公告横幅，也可以把暂时不可售的房型或钟点房楼栋关掉。" },
          { t: "房间数量", d: "在板块标签页中，设置每种房型同一晚最多可预订多少间。每一行还会显示今晚还剩多少间。单人床房和双床房共用同一个数量，因为是同一批房间，只是床位布置不同。" },
          { t: "无需手动增减", d: "您只需设置总数。有预订时，该房间从入住的那几晚扣除；住宿结束或预订取消后立即恢复。若想停售某个房型又不从网站隐藏，把数量设为 0 即可。" },
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "給賓客開收據", d: "在「付款紀錄」框中點「收據」。預設打開的是「內部存根」，還會顯示支付公司扣了多少、飯店實收多少。列印交給賓客的單據之前，請先切換到「賓客聯」—— 那會去掉手續費資訊，只保留住宿、金額、卡片和付款時間。然後再點列印。" },
          { t: "列印訂房單", d: "任何一筆訂房都可以點「列印訂房單」，包括還沒有收據、入住時才付款的訂房。預設打開的是「賓客聯」，以賓客自己的語言顯示，可以直接交給賓客：房間、日期、含哪些服務、合計以及尚需支付的金額。「櫃檯存根」會另外加上我們自己的資訊 —— 訂房管道、員工備註、付款紀錄，以及由誰取消、原因是什麼。這一聯不要交給賓客。然後點列印。" },
      ...
      },
      {
        ...
        steps: [
          ...
          { t: "線上聊天", d: "「線上聊天」分頁控制網站聊天助手對房客所說的內容。改寫任何回答，修改其中的時間或細節，選擇觸發它的詞語，開啟或關閉回答，或新增全新的回答 — 然後點擊「儲存線上聊天」。用你的語言輸入一次，系統會翻譯成另外四種語言，並立即送達每位房客的裝置。" },
          { t: "版塊", d: "打勾或取消打勾來顯示 / 隱藏版塊，在網站上方發布公告橫幅，也可以把暫時不可售的房型（房型上架狀態）或鐘點房棟別（鐘點房上架狀態）關掉。" },
          { t: "房間數量", d: "在版塊標籤頁中，設定每種房型同一晚最多可預訂多少間。每一列還會顯示今晚還剩多少間。單人床房和雙床房共用同一個數量，因為是同一批房間，只是床位配置不同。" },
          { t: "無需手動增減", d: "您只需設定總數。有預訂時，該房間從入住的那幾晚扣除；住宿結束或預訂取消後立即恢復。若想停售某個房型又不從網站隱藏，把數量設為 0 即可。" },
